...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        if groups != 1 or base_width != 64:
            raise ValueError('BasicBlock only supports groups=1 and base_width=64')  # noqa: E501
        if dilation > 1:
            raise NotImplementedError("Dilation > 1 not supported in BasicBlock")  # noqa: E501
...
class ResNet(nn.Module):
    def __init__(self, block, layers, input_dim, inplanes, num_classes=1000,
